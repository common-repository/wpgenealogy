<template>
    <div class="family-edit-event-association-edit">
        <div class="modal" id="family-edit-event-association-edit">
...
export default {
    ...
    methods: {
        ...
        findPeople: function() {
            ...
            jQuery('#family-edit-event-association-edit-people-find').modal('show')
        },
        peopleFound: function(people) {
            jQuery('#family-edit-event-association-edit-people-find').modal('hide')
