<template>
    <div class="family-edit-event-association-add">
        <div class="modal" id="family-edit-event-association-add">
...
export default {
    ...
    methods: {
        ...
        findPeople: function() {
            ...
            jQuery('#family-edit-event-association-add-people-find').modal('show')
        },
        peopleFound: function(people) {
            jQuery('#family-edit-event-association-add-people-find').modal('hide')
