<template>
	<div class="people-edit-event-note-citation-edit">
		<div class="modal" id="people-edit-event-note-citation-edit">
...
export default {
	...
	methods: {
		addSource: function() {
			jQuery('#people-edit-event-note-citation-edit-source-add').modal('show')
		},
		sourceAdded(source) {
			jQuery('#people-edit-event-note-citation-edit-source-add').modal('hide')
			this.citation.sourceID = source.sourceID
		},
		findSource: function() {
			jQuery('#people-edit-event-note-citation-edit-source-find').modal('show')
		},
		sourceFound(source) {
			jQuery('#people-edit-event-note-citation-edit-source-find').modal('hide')
			this.citation.sourceID = source.sourceID
		},
		citationUpdated: function() {
			this.$emit('citationUpdated', data);
		}
	}
}
</script>