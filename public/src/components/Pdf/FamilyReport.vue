<template>
	<div class="modal fade" id="pdf-family-report" tabindex="-1" aria-labelledby="pdfLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="pdf-family-report-title">PDF Generator</h5>
				...
				<div class="modal-body">
					<div>
						<p>
							<span v-if="pdfArg.family" class="normal">
								<strong>
									Family Report for  
									{{pdfArg.family.husbObj ? pdfArg.family.husbObj.name : '' }} 
									{{pdfArg.family.husband && pdfArg.family.wife  ? '/' : ''}} 
									{{pdfArg.family.wifeObj ? pdfArg.family.wifeObj.name : ''}} 
									({{pdfArg.family.familyID}}) 
								</strong>
							</span>
						</p>
						<div>
...
export default {
	...
	methods: {
		save(){
			...
			let data = {
				action: 'generate_pdf_family_report',
				query: this.query,
			}

			data.query.family = this.pdfArg.family.id,
