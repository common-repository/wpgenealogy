<template>
	<div class="modal fade" id="pdf-pedigree" tabindex="-1" aria-labelledby="pdfLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="pdf-pedigree-title">PDF Generator</h5>
				...
				<div class="modal-body">
					<div>
						<p>
							<span v-if="pdfArg.people" class="normal"><strong>Descendancy for {{ pdfArg.people.name }} ({{pdfArg.people.personID}})</strong></span>
						</p>
						<table id="genselect" cellpadding="0" class="table table-borderless w-auto">
							<tbody>
								<tr>
									<td>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" @click.prevent="save">
						<span v-if="spinner.save.spinning" class="spinner-border spinner-border-sm"></span> Create Chart </button>
				</div>
			</div>
		</div>
	</div>
